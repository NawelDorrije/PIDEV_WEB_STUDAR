 ...
 */
final class Version20250324165514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE logement ADD nbr_chambre INT NOT NULL, DROP nbrChambre, DROP utilisateur_cin, CHANGE description description VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE statut statut ENUM(\'DISPONIBLE\', \'NON_DISPONIBLE\') NOT NULL, CHANGE localisation localisation POINT NOT NULL COMMENT \'(DC2Type:point)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE logement ADD nbrChambre VARCHAR(255) NOT NULL, ADD utilisateur_cin VARCHAR(8) NOT NULL, DROP nbr_chambre, CHANGE description description TEXT DEFAULT NULL, CHANGE type type VARCHAR(100) DEFAULT NULL, CHANGE localisation localisation POINT DEFAULT NULL COMMENT \'(DC2Type:point)\', CHANGE statut statut VARCHAR(255) NOT NULL');
