 ...
 */
final class Version20250325144933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX image_logement_ibfk_1 ON image_logement');
        $this->addSql('ALTER TABLE image_logement ADD id INT AUTO_INCREMENT NOT NULL, ADD logement_id_id INT DEFAULT NULL, DROP logement_id, CHANGE id_image id_image INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE image_logement ADD CONSTRAINT FK_7F0DCAFF884C09A7 FOREIGN KEY (logement_id_id) REFERENCES logement (id)');
        $this->addSql('CREATE INDEX IDX_7F0DCAFF884C09A7 ON image_logement (logement_id_id)');
        $this->addSql('DROP INDEX fk_utilisateur ON logement');
        ...
        $this->addSql('DROP INDEX logement_options_ibfk_2 ON logement_options');
        $this->addSql('DROP INDEX IDX_AAE2EAD5A026A8C2 ON logement_options');
        $this->addSql('ALTER TABLE logement_options ADD id INT AUTO_INCREMENT NOT NULL, ADD id_logement_id INT DEFAULT NULL, ADD id_option_id INT DEFAULT NULL, DROP id_logement, DROP id_option, DROP valeur, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE logement_options ADD CONSTRAINT FK_AAE2EAD540B934A2 FOREIGN KEY (id_logement_id) REFERENCES logement (id)');
        $this->addSql('ALTER TABLE logement_options ADD CONSTRAINT FK_AAE2EAD527F1A148 FOREIGN KEY (id_option_id) REFERENCES options (id)');
        $this->addSql('CREATE INDEX IDX_AAE2EAD540B934A2 ON logement_options (id_logement_id)');
        $this->addSql('CREATE INDEX IDX_AAE2EAD527F1A148 ON logement_options (id_option_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_logement MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE image_logement DROP FOREIGN KEY FK_7F0DCAFF884C09A7');
        $this->addSql('DROP INDEX IDX_7F0DCAFF884C09A7 ON image_logement');
        $this->addSql('DROP INDEX `PRIMARY` ON image_logement');
        $this->addSql('ALTER TABLE image_logement ADD logement_id INT NOT NULL, DROP id, DROP logement_id_id, CHANGE id_image id_image INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('CREATE INDEX image_logement_ibfk_1 ON image_logement (logement_id)');
        $this->addSql('ALTER TABLE image_logement ADD PRIMARY KEY (id_image)');
        ...
        $this->addSql('CREATE INDEX fk_utilisateur ON logement (utilisateur_cin)');
        $this->addSql('ALTER TABLE logement_options MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE logement_options DROP FOREIGN KEY FK_AAE2EAD540B934A2');
        $this->addSql('ALTER TABLE logement_options DROP FOREIGN KEY FK_AAE2EAD527F1A148');
        $this->addSql('DROP INDEX IDX_AAE2EAD540B934A2 ON logement_options');
        $this->addSql('DROP INDEX IDX_AAE2EAD527F1A148 ON logement_options');
        $this->addSql('DROP INDEX `PRIMARY` ON logement_options');
        $this->addSql('ALTER TABLE logement_options ADD id_logement INT NOT NULL, ADD id_option INT NOT NULL, ADD valeur TINYINT(1) DEFAULT NULL, DROP id, DROP id_logement_id, DROP id_option_id');
        ...
        $this->addSql('CREATE INDEX logement_options_ibfk_2 ON logement_options (id_option)');
