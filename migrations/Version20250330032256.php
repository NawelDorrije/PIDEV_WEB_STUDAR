 ...
 */
final class Version20250330032256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE logement_options ADD logement_id INT NOT NULL, ADD option_id INT NOT NULL, DROP id_logement, DROP id_option');
        ...
        $this->addSql('ALTER TABLE logement_options ADD PRIMARY KEY (logement_id, option_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON logement_options');
        $this->addSql('ALTER TABLE logement_options ADD id_logement INT NOT NULL, ADD id_option INT NOT NULL, DROP logement_id, DROP option_id');
