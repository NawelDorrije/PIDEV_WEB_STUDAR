 ...
 */
final class Version20250403155318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD cin_proprietaire VARCHAR(8) NOT NULL, ADD cin_etudiant VARCHAR(8) NOT NULL, ADD id_logement VARCHAR(255) NOT NULL, DROP cinProprietaire, DROP cinEtudiant, DROP idLogement, CHANGE status status VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD cinProprietaire VARCHAR(8) DEFAULT NULL, ADD cinEtudiant VARCHAR(8) DEFAULT NULL, ADD idLogement VARCHAR(255) DEFAULT NULL, DROP cin_proprietaire, DROP cin_etudiant, DROP id_logement, CHANGE status status VARCHAR(255) DEFAULT \'en_attente\'');
