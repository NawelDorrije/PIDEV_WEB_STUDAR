 ...
 */
final class Version20250403164245 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_logement CHANGE status status ENUM(\'confirmée\', \'en_attente\', \'refusée\'), CHANGE cinEtudiant cin_etudiant VARCHAR(20) DEFAULT NULL, CHANGE cinProprietaire cin_proprietaire VARCHAR(8) DEFAULT NULL, CHANGE idLogement id_logement VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_logement CHANGE status status VARCHAR(255) DEFAULT \'en_attente\', CHANGE cin_etudiant cinEtudiant VARCHAR(20) DEFAULT NULL, CHANGE cin_proprietaire cinProprietaire VARCHAR(8) DEFAULT NULL, CHANGE id_logement idLogement VARCHAR(255) DEFAULT NULL');
