 ...
 */
final class Version20250403165533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_logement ADD date_debut DATE DEFAULT NULL, ADD date_fin DATE DEFAULT NULL, DROP dateDebut, DROP dateFin, CHANGE status status ENUM(\'confirmée\', \'en_attente\', \'refusée\'), CHANGE cinEtudiant cin_etudiant VARCHAR(20) DEFAULT NULL, CHANGE cinProprietaire cin_proprietaire VARCHAR(8) DEFAULT NULL, CHANGE idLogement id_logement VARCHAR(255) DEFAULT NULL');
