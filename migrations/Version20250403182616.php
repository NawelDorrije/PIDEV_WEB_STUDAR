 ...
 */
final class Version20250403182616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous DROP FOREIGN KEY fk_rendez_vous_cinEtudiant');
        $this->addSql('ALTER TABLE rendez_vous DROP FOREIGN KEY fk_rendez_vous_cinProprietaire');
        ...
        $this->addSql('DROP INDEX fk_cinProprietaire ON rendez_vous');
        $this->addSql('DROP INDEX fk_logement_id ON rendez_vous');
        $this->addSql('DROP INDEX fk_cinEtudiant ON rendez_vous');
        $this->addSql('ALTER TABLE rendez_vous CHANGE status status ENUM(\'confirmée\', \'en_attente\', \'refusée\'), CHANGE cinEtudiant cinEtudiant VARCHAR(20) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reservation_logement CHANGE status status ENUM(\'confirmée\', \'en_attente\', \'refusée\')');
        ...
        $this->addSql('ALTER TABLE reservation_transport ADD adresse_depart VARCHAR(255) DEFAULT NULL, ADD adresse_destination VARCHAR(255) DEFAULT NULL, ADD cin_etudiant VARCHAR(8) DEFAULT NULL, ADD cin_transporteur VARCHAR(8) DEFAULT NULL, DROP adresseDepart, DROP adresseDestination, DROP cinEtudiant, DROP cinTransporteur, CHANGE status status ENUM(\'confirmée\', \'en_attente\', \'refusée\'), CHANGE tempsArrivage temps_arrivage VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous CHANGE cinEtudiant cinEtudiant VARCHAR(8) DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT \'en_attente\'');
        $this->addSql('ALTER TABLE rendez_vous ADD CONSTRAINT fk_rendez_vous_cinEtudiant FOREIGN KEY (cinEtudiant) REFERENCES utilisateur (cin) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rendez_vous ADD CONSTRAINT fk_rendez_vous_cinProprietaire FOREIGN KEY (cinProprietaire) REFERENCES utilisateur (cin) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('CREATE INDEX fk_cinProprietaire ON rendez_vous (cinProprietaire)');
        $this->addSql('CREATE INDEX fk_logement_id ON rendez_vous (idLogement)');
        $this->addSql('CREATE INDEX fk_cinEtudiant ON rendez_vous (cinEtudiant)');
        $this->addSql('ALTER TABLE reservation_logement CHANGE status status VARCHAR(255) DEFAULT \'en_attente\'');
