 ...
 */
final class Version20250403183438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_transport CHANGE cinTransporteur cinTransporter VARCHAR(8) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_transport CHANGE cinTransporter cinTransporteur VARCHAR(8) DEFAULT NULL');
