 ...
 */
final class Version20250403232848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous CHANGE status status ENUM(\'confirmée\', \'en_attente\', \'refusée\') DEFAULT \'en_attente\', CHANGE cinEtudiant cinEtudiant VARCHAR(20) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous CHANGE cinEtudiant cinEtudiant VARCHAR(8) DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT \'en_attente\' NOT NULL');
