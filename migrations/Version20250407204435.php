 ...
 */
final class Version20250407204435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY message_ibfk_1');
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY message_ibfk_2');
        $this->addSql('ALTER TABLE message CHANGE senderCin senderCin VARCHAR(8) DEFAULT NULL, CHANGE receiverCin receiverCin VARCHAR(8) DEFAULT NULL, CHANGE content content LONGTEXT DEFAULT NULL, CHANGE timestamp timestamp DATETIME NOT NULL');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F3CD0097 FOREIGN KEY (senderCin) REFERENCES utilisateur (cin) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F38BA5EBC FOREIGN KEY (receiverCin) REFERENCES utilisateur (cin) ON DELETE SET NULL');
        $this->addSql('DROP INDEX sendercin ON message');
        $this->addSql('CREATE INDEX IDX_B6BD307F3CD0097 ON message (senderCin)');
        $this->addSql('DROP INDEX receivercin ON message');
        $this->addSql('CREATE INDEX IDX_B6BD307F38BA5EBC ON message (receiverCin)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lignes_panier (id INT AUTO_INCREMENT NOT NULL, id_panier INT NOT NULL, id_meuble INT NOT NULL, INDEX lignes_panier_ibfk_1 (id_panier), INDEX lignes_panier_ibfk_2 (id_meuble), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, date DATE DEFAULT NULL, heure VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'en_attente\' COLLATE `utf8mb4_general_ci`, cinProprietaire VARCHAR(8) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, cinEtudiant VARCHAR(8) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, idLogement VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, INDEX fk_cinProprietaire (cinProprietaire), INDEX fk_logement_id (idLogement), INDEX fk_cinEtudiant (cinEtudiant), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE reservation_logement (id INT AUTO_INCREMENT NOT NULL, dateDebut DATE DEFAULT NULL, dateFin DATE DEFAULT NULL, status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'en_attente\' COLLATE `utf8mb4_general_ci`, cinEtudiant VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, cinProprietaire VARCHAR(8) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, idLogement VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, INDEX fk_reservation_logement_cinEtudiant (cinEtudiant), INDEX fk_reservation_logement_cinProprietaire (cinProprietaire), INDEX fk_logement_id (idLogement), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307F3CD0097');
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307F38BA5EBC');
        $this->addSql('ALTER TABLE message CHANGE content content TEXT DEFAULT NULL, CHANGE timestamp timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE senderCin senderCin VARCHAR(20) DEFAULT NULL, CHANGE receiverCin receiverCin VARCHAR(20) DEFAULT NULL');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT message_ibfk_1 FOREIGN KEY (senderCin) REFERENCES utilisateur (cin) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT message_ibfk_2 FOREIGN KEY (receiverCin) REFERENCES utilisateur (cin) ON DELETE CASCADE');
        $this->addSql('DROP INDEX idx_b6bd307f3cd0097 ON message');
        $this->addSql('CREATE INDEX senderCin ON message (senderCin)');
        $this->addSql('DROP INDEX idx_b6bd307f38ba5ebc ON message');
        $this->addSql('CREATE INDEX receiverCin ON message (receiverCin)');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F3CD0097 FOREIGN KEY (senderCin) REFERENCES utilisateur (cin) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F38BA5EBC FOREIGN KEY (receiverCin) REFERENCES utilisateur (cin) ON DELETE SET NULL');
