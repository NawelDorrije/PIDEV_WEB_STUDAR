 ...
 */
final class Version20250407211529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport DROP FOREIGN KEY fk_id_voiture');
        $this->addSql('ALTER TABLE transport ADD driver_cin VARCHAR(50) NOT NULL, ADD reservation_reference VARCHAR(50) NOT NULL, DROP cin, DROP reservation_id, CHANGE id_voiture id_voiture INT DEFAULT NULL, CHANGE timestamp timestamp DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE voiture ADD owner_cin VARCHAR(50) NOT NULL, DROP cin, DROP num_serie, DROP photo, DROP disponibilite, DROP timestamp');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport DROP FOREIGN KEY FK_66AB212E377F287F');
        $this->addSql('ALTER TABLE transport ADD cin VARCHAR(8) NOT NULL, ADD reservation_id INT NOT NULL, DROP driver_cin, DROP reservation_reference, CHANGE id_voiture id_voiture INT NOT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'current_timestamp(6)\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE transport ADD CONSTRAINT FK_66AB212E377F287F FOREIGN KEY (id_voiture) REFERENCES voiture (id_voiture)');
        $this->addSql('ALTER TABLE voiture ADD cin VARCHAR(8) NOT NULL, ADD num_serie VARCHAR(12) NOT NULL, ADD photo VARCHAR(200) NOT NULL, ADD disponibilite VARCHAR(255) NOT NULL, ADD timestamp DATETIME DEFAULT \'current_timestamp(6)\' NOT NULL, DROP owner_cin');
