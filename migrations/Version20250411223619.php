 ...
 */
final class Version20250411223619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD utilisateur_id VARCHAR(8) DEFAULT NULL, CHANGE status status ENUM('confirmée', 'en_attente', 'refusée') DEFAULT 'en_attente', CHANGE cinEtudiant cinEtudiant VARCHAR(20) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD CONSTRAINT FK_65E8AA0AFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (cin)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_65E8AA0AFB88E14F ON rendez_vous (utilisateur_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur CHANGE role role VARCHAR(20) NOT NULL, CHANGE blocked blocked TINYINT(1) NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)'
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_65E8AA0AFB88E14F ON rendez_vous
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous DROP utilisateur_id, CHANGE cinEtudiant cinEtudiant VARCHAR(8) DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT 'en_attente' NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur CHANGE role role VARCHAR(255) NOT NULL, CHANGE blocked blocked TINYINT(1) DEFAULT 0, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
