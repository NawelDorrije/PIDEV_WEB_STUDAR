 ...
 */
final class Version20250412153001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voiture DROP cin, CHANGE timestamp timestamp DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voiture ADD cin VARCHAR(8) NOT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'current_timestamp(6)\' NOT NULL');
