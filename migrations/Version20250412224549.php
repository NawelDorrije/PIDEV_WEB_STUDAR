 ...
 */
final class Version20250412224549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport DROP id_voiture, DROP cin, DROP reservation_id, CHANGE status status VARCHAR(20) NOT NULL COMMENT \'(DC2Type:transport_status)\', CHANGE timestamp timestamp DATETIME NOT NULL');
        $this->addSql('DROP INDEX fk_cin_v ON voiture');
        $this->addSql('ALTER TABLE voiture DROP cin, CHANGE disponibilite disponibilite VARCHAR(20) NOT NULL COMMENT \'(DC2Type:voiture_disponibilite)\', CHANGE timestamp timestamp DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport ADD id_voiture INT NOT NULL, ADD cin VARCHAR(8) NOT NULL, ADD reservation_id INT NOT NULL, CHANGE status status VARCHAR(255) NOT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'current_timestamp(6)\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE voiture ADD cin VARCHAR(8) NOT NULL, CHANGE disponibilite disponibilite VARCHAR(255) NOT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'current_timestamp(6)\' NOT NULL');
