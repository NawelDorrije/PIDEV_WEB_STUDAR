 ...
 */
final class Version20250413014246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD logement_id INT DEFAULT NULL, DROP idLogement, CHANGE status status ENUM('confirmée', 'en_attente', 'refusée') DEFAULT 'en_attente'
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD CONSTRAINT FK_65E8AA0A58ABF955 FOREIGN KEY (logement_id) REFERENCES logement (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_65E8AA0A58ABF955 ON rendez_vous (logement_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous DROP FOREIGN KEY FK_65E8AA0A58ABF955
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_65E8AA0A58ABF955 ON rendez_vous
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous DROP FOREIGN KEY FK_65E8AA0A58090EBB
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD idLogement VARCHAR(255) DEFAULT NULL, DROP logement_id, CHANGE status status VARCHAR(255) DEFAULT 'en_attente' NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD CONSTRAINT fk_rendez_vous_cinEtudiant FOREIGN KEY (cinEtudiant) REFERENCES utilisateur (cin) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
