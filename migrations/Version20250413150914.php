 ...
 */
final class Version20250413150914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voiture DROP FOREIGN KEY fk_cin_v');
        $this->addSql('ALTER TABLE voiture CHANGE disponibilite disponibilite VARCHAR(20) NOT NULL COMMENT \'(DC2Type:voiture_disponibilite)\', CHANGE timestamp timestamp DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voiture DROP FOREIGN KEY FK_E9E2810FABE530DA');
        $this->addSql('ALTER TABLE voiture CHANGE disponibilite disponibilite VARCHAR(255) NOT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'current_timestamp(6)\' NOT NULL');
        $this->addSql('ALTER TABLE voiture ADD CONSTRAINT fk_cin_v FOREIGN KEY (cin) REFERENCES utilisateur (cin) ON UPDATE CASCADE ON DELETE CASCADE');
