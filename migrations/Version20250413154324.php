...
final class Version20250413154324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur ADD num_tel VARCHAR(20) DEFAULT NULL, DROP numTel, DROP reset_code, DROP blocked, DROP created_at, CHANGE cin cin VARCHAR(20) NOT NULL, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE role role VARCHAR(50) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur ADD numTel VARCHAR(15) DEFAULT NULL, ADD reset_code VARCHAR(10) DEFAULT NULL, ADD blocked TINYINT(1) DEFAULT 0, ADD created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, DROP num_tel, CHANGE cin cin VARCHAR(8) NOT NULL, CHANGE nom nom VARCHAR(50) NOT NULL, CHANGE prenom prenom VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE role role VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
