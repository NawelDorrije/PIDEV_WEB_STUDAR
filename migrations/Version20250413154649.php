 ...
 */
final class Version20250413154649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE logement CHANGE nbrChambre nbrChambre INT NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE utilisateur_cin utilisateur_cin VARCHAR(20) DEFAULT NULL, CHANGE localisation localisation POINT NOT NULL COMMENT '(DC2Type:point)'
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD id_logement INT NOT NULL, DROP idLogement, CHANGE date date DATE NOT NULL, CHANGE heure heure VARCHAR(50) NOT NULL, CHANGE status status VARCHAR(50) NOT NULL, CHANGE cinProprietaire cinProprietaire VARCHAR(20) DEFAULT NULL, CHANGE cinEtudiant cinEtudiant VARCHAR(20) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation_logement CHANGE status status ENUM('confirmée', 'en_attente', 'refusée') DEFAULT 'en_attente', CHANGE cinProprietaire cinProprietaire VARCHAR(20) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation_transport CHANGE status status ENUM('confirmée', 'en_attente', 'refusée') DEFAULT 'en_attente', CHANGE cinEtudiant cinEtudiant VARCHAR(20) DEFAULT NULL, CHANGE cinTransporteur cinTransporteur VARCHAR(20) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur ADD num_tel VARCHAR(20) DEFAULT NULL, DROP numTel, DROP reset_code, DROP created_at, CHANGE cin cin VARCHAR(20) NOT NULL, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE role role VARCHAR(50) NOT NULL, CHANGE blocked blocked TINYINT(1) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD idLogement VARCHAR(255) DEFAULT NULL, DROP id_logement, CHANGE date date DATE DEFAULT NULL, CHANGE heure heure VARCHAR(50) DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT 'en_attente' NOT NULL, CHANGE cinProprietaire cinProprietaire VARCHAR(8) DEFAULT NULL, CHANGE cinEtudiant cinEtudiant VARCHAR(8) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE rendez_vous ADD CONSTRAINT fk_rendez_vous_cinEtudiant FOREIGN KEY (cinEtudiant) REFERENCES utilisateur (cin) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation_logement CHANGE status status VARCHAR(255) DEFAULT 'en_attente' NOT NULL, CHANGE cinProprietaire cinProprietaire VARCHAR(8) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation_transport CHANGE status status VARCHAR(255) DEFAULT 'en_attente', CHANGE cinEtudiant cinEtudiant VARCHAR(8) DEFAULT NULL, CHANGE cinTransporteur cinTransporteur VARCHAR(8) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur ADD numTel VARCHAR(15) DEFAULT NULL, ADD reset_code VARCHAR(10) DEFAULT NULL, ADD created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, DROP num_tel, CHANGE cin cin VARCHAR(8) NOT NULL, CHANGE nom nom VARCHAR(50) NOT NULL, CHANGE prenom prenom VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE role role VARCHAR(255) NOT NULL, CHANGE blocked blocked TINYINT(1) DEFAULT 0
        SQL);
        $this->addSql(<<<'SQL'
