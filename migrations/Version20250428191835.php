 ...
 */
final class Version20250428191835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport ADD loading_time_actual INT DEFAULT NULL, ADD unloading_time_actual INT DEFAULT NULL, ADD loading_time_allowed INT DEFAULT 30 NOT NULL, ADD unloading_time_allowed INT DEFAULT 30 NOT NULL, ADD extra_cost DOUBLE PRECISION DEFAULT NULL, CHANGE timestamp timestamp DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport DROP loading_time_actual, DROP unloading_time_actual, DROP loading_time_allowed, DROP unloading_time_allowed, DROP extra_cost, CHANGE timestamp timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
