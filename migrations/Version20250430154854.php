 ...
 */
final class Version20250430154854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport CHANGE timestamp timestamp DATETIME NOT NULL, CHANGE extraCost 	extraCost DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport CHANGE timestamp timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE 	extraCost extraCost DOUBLE PRECISION DEFAULT NULL');
