 ...
 */
final class Version20250501202636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport CHANGE status status VARCHAR(20) NOT NULL COMMENT \'(DC2Type:transport_status)\', CHANGE timestamp timestamp DATETIME NOT NULL, CHANGE stripe_invoice_id stripe_invoice_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport CHANGE status status VARCHAR(255) DEFAULT \'En attente\' NOT NULL, CHANGE timestamp timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE stripe_invoice_id stripe_invoice_id VARCHAR(255) DEFAULT NULL COMMENT \'Stripe Invoice Reference\'');
