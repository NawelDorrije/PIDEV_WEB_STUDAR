...
final class ReservationLogementController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $reservationLogement->setEtudiant($this->getUser());
    ...
    {
        $utilisateur = $this->getUser();
        if (!$utilisateur instanceof Utilisateur || $reservationLogement->getEtudiant() !== $utilisateur) {
    ...
    {
        $utilisateur = $this->getUser();
        if (!$utilisateur instanceof Utilisateur || $reservation->getEtudiant() !== $utilisateur) {
    ...
    public function statisticsOwner(ReservationLogementRepository $repository): Response
    {
        ...
        $cinProprietaire = $utilisateur->getCin();
