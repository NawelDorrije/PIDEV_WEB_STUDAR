...
#[Route('/logement')]
final class LogementAdmineController extends AbstractController
{
    ...
    #[Route('/Admin', name: 'app_logement_index_admin', methods: ['GET'])]
    ...
    #[Route('/Admin/logement/filtrage', name: 'app_logement_index_filtrage_admin', methods: ['GET'])]
    ...
    #[Route('/Admin/new', name: 'app_logement_new_admin', methods: ['GET', 'POST'])]
    ...
    #[Route('/Admin/{id}', name: 'app_logement_show_admin', methods: ['GET'])]
    ...
    #[Route('/Admin/{id}/edit', name: 'app_logement_edit_admin', methods: ['GET', 'POST'])]
    ...
    #[Route('/Admin/{id}', name: 'app_logement_delete_admin', methods: ['POST'])]
