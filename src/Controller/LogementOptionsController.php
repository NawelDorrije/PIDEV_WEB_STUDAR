...
#[Route('/logement/options')]
final class LogementOptionsController extends AbstractController
{
    ...
    {
        return $this->render('logement_options/index.html.twig', [
    ...
    public function new(
        ...
        return $this->render('logement_options/new.html.twig', [
    ...
    public function show(LogementOptionsRepository $repo, int $logement, int $option): Response
    {
        ...
        return $this->render('logement_options/show.html.twig', [
    ...
    public function edit(
        ...
        return $this->render('logement_options/edit.html.twig', [
            'logement_option' => $logementOption,
            'form' => $form->createView(),
        ]);
    }
